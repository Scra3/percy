...
module('TodoMVC 8', function (hooks) {
  ...
  test('Loads the app 8', async function (assert) {
    assert.dom('section.todoapp').exists();
    await percySnapshot(assert);
  });

  test('Accepts a new todo 8', async function (assert) {
  ...
  test('Lets you check off a todo 8', async function (assert) {
