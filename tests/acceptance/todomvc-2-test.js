...
module('TodoMVC 2', function (hooks) {
  ...
  test('Loads the app 3', async function (assert) {
    assert.dom('section.todoapp').exists();
    await percySnapshot(assert);
  });

  test('Accepts a new todo 3', async function (assert) {
  ...
  test('Lets you check off a todo 3', async function (assert) {
