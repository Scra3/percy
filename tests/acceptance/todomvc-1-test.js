...
module('TodoMVC 1', function (hooks) {
  ...
  test('Loads the app 2', async function (assert) {
    assert.dom('section.todoapp').exists();
    await percySnapshot(assert);
  });

  test('Accepts a new todo 2', async function (assert) {
  ...
  test('Lets you check off a todo 2', async function (assert) {
