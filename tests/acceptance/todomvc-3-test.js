...
module('TodoMVC 3', function (hooks) {
  ...
  test('Loads the app 4', async function (assert) {
    assert.dom('section.todoapp').exists();
    await percySnapshot(assert);
  });

  test('Accepts a new todo 4', async function (assert) {
  ...
  test('Lets you check off a todo 4', async function (assert) {
