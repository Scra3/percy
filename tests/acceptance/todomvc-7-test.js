...
module('TodoMVC 7', function (hooks) {
  ...
  test('Loads the app 1', async function (assert) {
    assert.dom('section.todoapp').exists();
    await percySnapshot(assert);
  });

  test('Accepts a new todo 7', async function (assert) {
  ...
  test('Lets you check off a todo 7', async function (assert) {
