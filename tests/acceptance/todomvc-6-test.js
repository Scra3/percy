...
module('TodoMVC 6', function (hooks) {
  ...
  test('Loads the app 7', async function (assert) {
    assert.dom('section.todoapp').exists();
    await percySnapshot(assert);
  });

  test('Accepts a new todo 6', async function (assert) {
  ...
  test('Lets you check off a todo 6', async function (assert) {
