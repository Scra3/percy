...
module('TodoMVC 5', function (hooks) {
  ...
  test('Loads the app 6', async function (assert) {
    assert.dom('section.todoapp').exists();
    await percySnapshot(assert);
  });

  test('Accepts a new todo 5', async function (assert) {
  ...
  test('Lets you check off a todo 1', async function (assert) {
